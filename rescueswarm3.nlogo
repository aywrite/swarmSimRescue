...
to go
  ...
  ask base [
    ask searchers in-radius comRange [
      ;compare with master list
      ;if a new rescuer is on the list, mark as found
      ask foundNO [
